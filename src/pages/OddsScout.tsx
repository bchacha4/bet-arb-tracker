          ...
          <Card className="mb-4 bg-white">
            <CardContent className="pt-3">
              ...
              <div className="space-y-2 text-gray-600 text-sm">
                ...
                <h3 className="text-base font-semibold mt-4 mb-2">What Can Odds Scout Do for You?</h3>
                ...
                <h3 className="text-base font-semibold mt-4 mb-2">How to Use Odds Scout</h3>
                <ul className="list-disc pl-5 space-y-1">
