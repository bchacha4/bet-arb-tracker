        ...
        <div className="space-y-6">
          ...
          {isMobile ? (
            <Collapsible open={isOpen} onOpenChange={setIsOpen}>
              <Card className="mb-4 bg-white border-0 shadow-lg rounded-xl transition-all duration-300 hover:shadow-xl">
                <CardContent className="p-6">
                  <div className="flex justify-between items-center">
                    <h2 className="text-xl font-semibold mb-2 text-gray-900">Welcome to Odds Scout</h2>
                    <CollapsibleTrigger className="p-2 hover:bg-gray-100 rounded-full transition-colors duration-200">
                    ...
                    <div className="space-y-4 text-gray-600 text-sm">
                      ...
                      <div className="space-y-4">
                        <div className="bg-gray-50 p-4 rounded-xl border border-gray-100">
                          <h3 className="text-base font-semibold mb-3 text-gray-900">What Can Odds Scout Do for You?</h3>
                        ...
                        <div className="bg-gray-50 p-4 rounded-xl border border-gray-100">
                          <h3 className="text-base font-semibold mb-3 text-gray-900">How to Use Odds Scout</h3>
                          <ul className="space-y-3">
                            <li className="flex items-start gap-3">
                      ...
                      <p className="text-sm text-gray-500 italic border-l-2 border-primary pl-3 mt-4 bg-gray-50 p-3 rounded-r-xl">
            ...
            <Card className="mb-4 bg-white border-0 shadow-lg rounded-xl transition-all duration-300 hover:shadow-xl">
              <CardContent className="p-8">
                <h2 className="text-2xl font-semibold mb-6 text-gray-900 bg-clip-text">Welcome to Odds Scout</h2>
                <div className="space-y-6 text-gray-600">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="bg-gray-50 p-6 rounded-xl border border-gray-100 transition-all duration-300 hover:border-primary/20">
                      <h3 className="text-lg font-semibold mb-4 text-gray-900">What Can Odds Scout Do for You?</h3>
                    ...
                    <div className="bg-gray-50 p-6 rounded-xl border border-gray-100 transition-all duration-300 hover:border-primary/20">
                      <h3 className="text-lg font-semibold mb-4 text-gray-900">How to Use Odds Scout</h3>
                      <ul className="space-y-4">
                        <li className="flex items-start gap-3">
                  ...
                  <p className="text-sm text-gray-500 italic border-l-2 border-primary pl-4 py-3 bg-gray-50 rounded-r-xl">
                    Odds are updated regularly to ensure you have the most accurate data available.
                  </p>
                </div>
              </CardContent>
